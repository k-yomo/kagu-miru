  ...
  return (
    <>
      ...
      <div className="mx-auto p-3 max-w-[1000px] rounded-lg">
        ...
        <div id="post" className="my-8">
          <p>
            カグミル運営事務局（以下，「当事務局」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
          </p>
          ...
          <ul>
            ...
            <li>
              予め次の事項を告知あるいは公表し，かつ当事務局が個人情報保護委員会に届出をしたとき
            </li>
          ...
          <p>
            ユーザーは，当事務局の保有する自己の個人情報が誤った情報である場合には，当事務局が定める手続きにより，当事務局に対して個人情報の訂正，追加または削除（以下，「訂正等」といいます。）を請求することができます。
          </p>
          <p>
            当事務局は，ユーザーから前項の請求を受けてその請求に応じる必要があると判断した場合には，遅滞なく，当該個人情報の訂正等を行うものとします。
          </p>
          <p>
          ...
          <p>
            当事務局は，前項の規定に基づき利用停止等を行った場合，または利用停止等を行わない旨の決定をしたときは，遅滞なく，これをユーザーに通知します。
          </p>
          <p>
          ...
          <p>
            本ポリシーに関するお問い合わせは，
            <a className="underline" href={routes.contact()}>
              お問い合わせページ
            </a>
            からお願いいたします。
          </p>
